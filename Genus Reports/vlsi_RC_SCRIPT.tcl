...
set dir /home/iiitdm/Desktop/log/COE17B010/VLSI_Files-master/MAC/NonDuplicates
set myFiles [list MAC_16Bit.v] ;# All your HDL files
set basename MAC_16Bit;# name of top level module
set myClk clk ;# clock name
set myPeriod_ps 13500 ;# Clock period in ps - MHz
set myInDelay_ps  2500 ;# delay from clock to inputs valid - 0.1 ns
set myOutDelay_ps 2500 ;# delay from clock to output valid - 0.1 ns
